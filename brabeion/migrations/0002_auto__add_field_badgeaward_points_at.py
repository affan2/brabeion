...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BadgeAward.points_at'
        db.add_column(u'brabeion_badgeaward', 'points_at',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BadgeAward.points_at'
        db.delete_column(u'brabeion_badgeaward', 'points_at')
