...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BadgeAward.site'
        db.add_column(u'brabeion_badgeaward', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BadgeAward.site'
        db.delete_column(u'brabeion_badgeaward', 'site_id')
    ...
    models = {
        ...
        u'brabeion.badgeaward': {
            'Meta': {'object_name': 'BadgeAward'},
            'awarded_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.IntegerField', [], {}),
            'points_at': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'default': '2', 'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'badges_earned'", 'to': u"orm['auth.User']"})
        },
